...
while (<File>) {
	...
	if (exists $gffgene{$gene}){
		...
		print Results "$subl2[0]\tAnnotGFF\tgene\t$subl2[3]\t$subl2[4]\t$subl2[5]\t$subl2[6]\t$subl2[7]\tID=$geneparent;$subline[4];$subline[1];Pos:$subline[2]-$subline[3]\n";
...
while (<File>) {
	...
	if (exists $gffgene{$gene}){
		...
		print Results "$subl2[0]\tAnnotGFF\tgene\t$inigene\t$endgene\t$subl2[5]\t$subl2[6]\t$subl2[7]\tID=$geneparent;$subline[4];$subline[1];Pos:$subline[2]-$subline[3]\n";
		print Results "$subl2[0]\tAnnotGFF\tmRNA\t$inigene\t$endgene\t$subl2[5]\t$subl2[6]\t$subl2[7]\tID=$subline[0];Parent=$geneparent;$subline[4];$subline[1];Pos:$subline[2]-$subline[3]\n";
